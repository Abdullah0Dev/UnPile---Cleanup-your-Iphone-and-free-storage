...
async function run(): Promise<void> {
  ...
  let questions = [
    ...
    "How to speed up iPhone by clearing storage",
    "Why is system data taking up so much iPhone storage?",
    "How to delete duplicate photos on iPhone",
    "How to delete thousands of photos quickly on iPhone",
    "Best free iPhone cleaner apps that actually work",
    "Does Apple's built-in cleanup tool really work?",
    "What's taking up all my iPhone storage space?",
    "How to check which apps are using most storage on iPhone",
    "How to clear cache on iPhone to free up space",
    "How to delete old app data and free up iPhone storage",
    "iPhone storage full quick fixes that actually work",
    "How much free storage do I actually need on my iPhone?",
    "Can I clean up iPhone storage without a subscription app?",
    "How to clean up iPhone storage without losing important photos",
    "Should I use a third-party app to clean my iPhone?",
    "What's the safest free tool to clean iPhone storage?",
    "Is it safe to delete old backups to free up iPhone storage?",
    "How to permanently delete files from iPhone storage",
    "How to manage iPhone storage before it becomes critical",
    "How often should you clean up your iPhone storage?",
    "Does deleting apps really free up iPhone storage?",
    "Why does Instagram take up so much iPhone storage?",
    "Why do downloaded videos take up so much phone storage?",
    "iPhone storage cleanup: is it safe or will I lose data?",
    "Best way to back up photos before cleaning iPhone storage",
    "How to find and delete duplicate photos on iPhone",
    "Can you clean up iCloud storage separately from iPhone?",
    "How to clean up iPhone storage when it's completely full",
    "How to clean up iPhone storage without using iCloud",
    "How to move photos to external storage to free up iPhone",
    "Can you clean up iPhone storage on older device models?",
    "iPhone storage cleanup: manual vs automatic tools",
    "What happens if you don't clean up iPhone storage?",
    "Best apps for managing iPhone storage without monthly fees",
    "Why keep getting 'storage full' alerts even after deleting?",
    "iPhone storage cleanup: should I use airplane mode?",
    "Best strategy for cleaning up 10,000+ photos on iPhone",
    "Why some iPhone cleaner apps require subscription and others don't",
    "How much iPhone storage do I need for Apple Intelligence?"
];
